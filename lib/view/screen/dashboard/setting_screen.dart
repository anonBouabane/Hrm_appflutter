...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Padding signout(BuildContext context) {
    return Padding(
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                    decoration: const BoxDecoration(
                      border: Border(
                          top: BorderSide(color: Colors.red, width: 1.2),
                          bottom: BorderSide(color: Colors.red, width: 1.2),
                          left: BorderSide(color: Colors.red, width: 1.2),
                          right: BorderSide(color: Colors.red, width: 1.2)),
  ...
  SizedBox policy(BuildContext context) {
    return SizedBox(
        child: Card(
      child: Padding(
        padding: const EdgeInsets.all(8.0),
